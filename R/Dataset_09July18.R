...
data.tn<-epinut[,c("lagoslakeid", "nh4", "no2no3", "tn", "nh4_detectionlimit", "no2no3_detectionlimit", "tn_detectionlimit", "sampleyear", "samplemonth")]
data.tkn<-epinut[,c("lagoslakeid", "nh4", "no2no3", "tkn", "nh4_detectionlimit", "no2no3_detectionlimit", "tkn_detectionlimit", "sampleyear", "samplemonth")]
...
##pick out last of each lagoslakeid observations
library(data.table)
...
write.csv(oneobs, file="LagosNSpeciesData_latlong_10July2018.csv")
